...
export default function FastabiqulKhairat() {
  return (
    <section
      ...
      className="relative -mt-12 sm:-mt-16 md:-mt-20 z-20 pt-12 pb-12 sm:pt-14 sm:pb-14 md:pt-16 md:pb-16 bg-gradient-to-b from-[#09162C] via-[#060E1D] to-[#040914] rounded-t-[36px] sm:rounded-t-[48px] md:rounded-t-[60px] border-t border-[#14B8A6]/25 shadow-[0_-12px_35px_rgba(4,9,20,0.16)] overflow-hidden flex flex-col items-center justify-center text-center"
    >
      ...
      <div className="max-w-3xl mx-auto px-5 sm:px-8 relative z-10">
        ...
        >
          <p
            dir="rtl"
            lang="ar"
            className={`${amiri.className} text-3xl sm:text-4xl md:text-[44px] text-white font-normal tracking-wide leading-[1.6] select-none drop-shadow-[0_2px_12px_rgba(20,184,166,0.15)]`}
          >
        ...
        >
          <span className="w-6 sm:w-10 h-[1px] bg-gradient-to-r from-transparent to-[#14B8A6]/70" />
          <h3 className="font-heading text-xs sm:text-[13px] md:text-sm font-bold uppercase tracking-[0.24em] text-[#14B8A6]">
            Fastabiqul Khairat
          </h3>
          <span className="w-6 sm:w-10 h-[1px] bg-gradient-to-l from-transparent to-[#14B8A6]/70" />
        </motion.div>

        {/* 3. Supporting Translation Quote */}
        <motion.h2
          initial={{ opacity: 0, y: 10 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6, delay: 0.15 }}
          className="font-heading font-bold text-xl sm:text-2xl md:text-[28px] lg:text-[30px] text-slate-100 tracking-tight leading-[1.25] sm:leading-[1.2] max-w-2xl mx-auto mb-3.5 sm:mb-4"
        >
